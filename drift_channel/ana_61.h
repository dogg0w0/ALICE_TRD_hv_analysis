...
// Mon Nov 30 14:23:44 2020 by ROOT version 6.22/03
// from TTree TOF_T0_Tree/data from matched csv
// found on file: sorted_61.csv.root
//////////////////////////////////////////////////////////
...
#ifdef ana_61_cxx
ana_61::ana_61(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("sorted_61.csv.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("sorted_61.csv.root");
      }
...
Int_t ana_61::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_61::LoadTree(Long64_t entry)
{
...
void ana_61::Show(Long64_t entry)
{
...
Int_t ana_61::Cut(Long64_t entry)
{
