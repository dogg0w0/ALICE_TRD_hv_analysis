{
    ...
    if (kfit)
    {
        TF1 *g0 = new TF1("g0", "gaus", 0.0, 0.2);
        TF1 *g1 = new TF1("g1", "gaus", 0.0, 0.2);
        TF1 *g2 = new TF1("g2", "gaus", 0.0, 0.2);
        TF1 *g3 = new TF1("g3", "gaus", 0.0, 0.2);
        TF1 *g4 = new TF1("g4", "gaus", 0.0, 0.2);
        TF1 *g5 = new TF1("g5", "gaus", 0.0, 0.2);
        h_0->Fit(g0, "R W");
        h_1->Fit(g1, "R W");
        h_2->Fit(g2, "R W");
        h_3->Fit(g3, "R W");
