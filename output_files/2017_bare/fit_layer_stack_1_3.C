{
    ...
    if (kfit)
    {
        ...
        tex->DrawLatex(0.2, 0.88, "Gauss Fit Layer 0");
        char buffer_M[100],
            buffer_S[100];
        ...
        tex->DrawLatex(0.2, 0.85, buffer_M);
        tex->DrawLatex(0.2, 0.82, buffer_S);

        tex->DrawLatex(0.2, 0.78, "Gauss Fit Layer 1");
        ...
        tex->DrawLatex(0.2, 0.75, buffer_M);
        tex->DrawLatex(0.2, 0.72, buffer_S);

        tex->DrawLatex(0.2, 0.68, "Gauss Fit Layer 2");
        ...
        tex->DrawLatex(0.2, 0.65, buffer_M);
        tex->DrawLatex(0.2, 0.62, buffer_S);

        tex->DrawLatex(0.2, 0.58, "Gauss Fit Layer 3");
        ...
        tex->DrawLatex(0.2, 0.55, buffer_M);
        tex->DrawLatex(0.2, 0.52, buffer_S);

        tex->DrawLatex(0.2, 0.48, "Gauss Fit Layer 4");
        ...
        tex->DrawLatex(0.2, 0.45, buffer_M);
        tex->DrawLatex(0.2, 0.42, buffer_S);

        tex->DrawLatex(0.2, 0.38, "Gauss Fit Layer 5");
        ...
        tex->DrawLatex(0.2, 0.35, buffer_M);
        tex->DrawLatex(0.2, 0.32, buffer_S);
    }
}