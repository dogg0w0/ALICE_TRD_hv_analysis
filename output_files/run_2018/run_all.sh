...
do
    ...
    do
        echo $date
        ./analysis_run ${sector} /home/doggo/Downloads/ALICE_TRD/create_csv/output/date_${date}/ /home/doggo/Downloads/ALICE_TRD/create_chamber_map/outfile.txt /home/doggo/Downloads/ALICE_TRD/hv_ALICE_Data/ 1534797124 1534833676
    done
