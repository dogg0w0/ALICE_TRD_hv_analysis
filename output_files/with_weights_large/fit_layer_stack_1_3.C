{
    ...
    auto h_0 = new TH1D("h_0", "Slope Fit Param Hists in Layer 0", 40, 0.02, 0.2);
    auto h_1 = new TH1D("h_1", "Slope Fit Param Hists in Layer 1", 40, 0.02, 0.2);
    auto h_2 = new TH1D("h_2", "Slope Fit Param Hists in Layer 2", 40, 0.02, 0.2);
    auto h_3 = new TH1D("h_3", "Slope Fit Param Hists in Layer 3", 40, 0.02, 0.2);
    auto h_4 = new TH1D("h_4", "Slope Fit Param Hists in Layer 4", 40, 0.02, 0.2);
    auto h_5 = new TH1D("h_5", "Slope Fit Param Hists in Layer 5", 40, 0.02, 0.2);
    ...
    h_0->GetYaxis()->SetRangeUser(0, 0.6);
    h_0->GetXaxis()->SetRangeUser(0.04, 0.18);
