{
    ...
    if (kfit)
    {
        TF1 *g0 = new TF1("g0", "gaus", 0.04, 0.18);
        TF1 *g1 = new TF1("g1", "gaus", 0.04, 0.16);
        TF1 *g2 = new TF1("g2", "gaus", 0.04, 0.16);
        TF1 *g3 = new TF1("g3", "gaus", 0.04, 0.16);
        TF1 *g4 = new TF1("g4", "gaus", 0.02, 0.13);
        TF1 *g5 = new TF1("g5", "gaus", 0.035, 0.12);
        h_0->Fit(g0, "R W");
        h_1->Fit(g1, "R W");
        h_2->Fit(g2, "R W");
        h_3->Fit(g3, "R W");
    ...
    h_0->GetYaxis()->SetRangeUser(0, 0.9);
