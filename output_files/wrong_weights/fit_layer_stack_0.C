{
    ...
    Int_t  nbins = 6;
    auto h_0 = new TH1D("h_0", "Slope Fit Param Hists in Layer 0", nbins, 0.08, 0.2);
    auto h_1 = new TH1D("h_1", "Slope Fit Param Hists in Layer 1", nbins, 0.08, 0.2);
    auto h_2 = new TH1D("h_2", "Slope Fit Param Hists in Layer 2", nbins, 0.08, 0.2);
    auto h_3 = new TH1D("h_3", "Slope Fit Param Hists in Layer 3", nbins, 0.08, 0.2);
    auto h_4 = new TH1D("h_4", "Slope Fit Param Hists in Layer 4", nbins, 0.08, 0.2);
    auto h_5 = new TH1D("h_5", "Slope Fit Param Hists in Layer 5", nbins, 0.08, 0.2);
    ...
    if (kfit)
    {
        ...
        TF1 *g1 = new TF1("g1", "gaus", 0.09, 0.2);
        TF1 *g2 = new TF1("g2", "gaus", 0.09, 0.2);
        TF1 *g3 = new TF1("g3", "gaus", 0.09, 0.2);
        TF1 *g4 = new TF1("g4", "gaus", 0.09, 0.2);
        TF1 *g5 = new TF1("g5", "gaus", 0.09, 0.2);
        h_0->Fit(g0, "R W");
        h_1->Fit(g1, "R W");
        h_2->Fit(g2, "R W");
        h_3->Fit(g3, "R W");
