...
do
    ...
    python code/match_lumi_current_all.py /home/doggo/Downloads/ALICE_TRD/create_csv/temp_all/match_hv_current/ output_all/current/current_date_${tofFileindex}.csv
    python code/match_lumi_current.py output_all/current/current_date_${tofFileindex}.csv temp_all/tof_t0/tof_t0_${tofFileindex}.csv temp_all/match_current_lumi/matched_lumi_current_${tofFileindex}.csv
    ./code/makeroot_all.o temp_all/match_current_lumi/matched_lumi_current_${tofFileindex}.csv output_all/date_${tofFileindex}/current_lumi.csv.root
done
