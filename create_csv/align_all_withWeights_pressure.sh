...
rm -rf temp_all
rm -rf output_all_withWights_pres
...
if [ ! -d "output_all_withWights_pres" ]; then
    mkdir -p output_all_withWights_pres/current
fi
...
do
    ...
    mkdir -p output_all_withWights_pres/date_${tofFileindex}
    ...
    do
        ...
        do
            ...
            python code/match_hv_current_withWeights.py temp_all/sortedcsv/sorted_${index}.csv temp_all/sortedcsv/sorted_$((${index} + 1)).csv temp_all/match_hv_current/hv_current_${index}.csv ${index_i} /home/doggo/Downloads/ALICE_TRD/pressurevstime.csv
        done
    done
    python code/match_lumi_current_all.py /home/doggo/Downloads/ALICE_TRD/create_csv/temp_all/match_hv_current/ output_all_withWights_pres/current/current_date_${tofFileindex}.csv
    python code/match_lumi_current.py output_all_withWights_pres/current/current_date_${tofFileindex}.csv temp_all/tof_t0/tof_t0_${tofFileindex}.csv temp_all/match_current_lumi/matched_lumi_current_${tofFileindex}.csv
    ./code/makeroot_all_pres.o temp_all/match_current_lumi/matched_lumi_current_${tofFileindex}.csv output_all_withWights_pres/date_${tofFileindex}/current_lumi.csv.root
done
