...
// Tue Oct 27 13:51:21 2020 by ROOT version 6.22/03
// from TTree Results/Results
// found on file: trendingOCDB_2018.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("trendingOCDB_2018.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("trendingOCDB_2018.root");
      }
