...
void cor2017::Loop()
{
   ...
   auto h_p_g = new TH2F("h_p_g", "Gain vs. Pressure; Pressure (hPa); Gain (arb. u.)", 10, 967.8, 968, 100, 0.35, 0.6);
   ...
   h1->SetTitle("run 277530");
   h2->SetTitle("run 277531");
   h3->SetTitle("run 277534");
   ...
   c->SaveAs("gain_2017.pdf");

   auto c1 = new TCanvas();
   h_p_g->Draw();
   c1->SaveAs("gain_pressure_2017.pdf");
}
